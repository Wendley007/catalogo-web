  ...
  return (
    <>
      ...
      >
        ...
        {/* Sidebar Menu */}
        <section className="absolute top-0 right-0 h-[90vh] w-[350px] rounded-l-2xl bg-gradient-to-r from-green-50 to-blue-50 shadow-2xl overflow-hidden z-50 transition-all duration-500 ease-out">
          {/* Header */}
